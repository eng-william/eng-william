...
1. [Formas de Execução do n8n](#️-formas-de-execução-do-n8n)
2. [Pré-requisitos: Instalando o Node.js](#-pré-requisitos-instalando-o-nodejs)
3. [Instalando o n8n com npx](#-instalando-o-n8n-com-npx)
4. [Comandos Básicos do n8n](#-comandos-básicos-do-n8n)
...
> - 💬 [Comunidade n8n (fórum)](https://community.n8n.io/)
> - 🧱 [Exemplos de Workflows](https://n8n.io/workflows)
> - 🧑‍💻 [Código-fonte no GitHub](https://github.com/n8n-io/n8n)
> - 📹 [Canal do YouTube com tutoriais](https://www.youtube.com/@n8n_io)
