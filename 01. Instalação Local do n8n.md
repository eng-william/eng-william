...
- [⚙️ Formas de Execução do n8n](#️-formas-de-execução-do-n8n)
- [🧰 Pré-requisitos: Instalando o Node.js](#-pré-requisitos-instalando-o-nodejs)
- [📦 Instalando o n8n com npx](#-instalando-o-n8n-com-npx)
- [🧪 Comandos Básicos do n8n](#-comandos-básicos-do-n8n)
